        ...
        <div class="flex items-center justify-center mx-4 ">
          ...
          <div class="border-t-2 border-solid border-[#9EA7B8] flex-grow"></div>
				...
				<div
					...
					onClick={() => {
						const isRefund = buttonText === 'Get refund';
						const subscriptionId =
							subscribedPlan[0]?.subscriptionId || 'N/A';
						// console.log("Tracking Event Sent:", {
						//   event: isRefund ? "RefundRequested" : "SubscriptionCancelled",
						...
						cancelSubscription(
							subscriptionId,
							isRefund ? isRefundEligible || false : false,
							token || '',
						);
						...
						router.push(
							isRefund
								? '/manage_subscription_cancel_clicked'
								: '/manage_subscription_cancel_clicked',
						);
					}}>
					<CustomButton
