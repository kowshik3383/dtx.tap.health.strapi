...
import { BuyButton, PlanCard1, PromotionBanner } from './ui';
const logger = {
...
const PlansContainer1 = ({
	...
	const isUpgradePage = pathname === '/upgrade-plans';
	...
	const handleSubscribe = async () => {
		...
		localStorage.setItem('isFromV2plans', 'true');
	...
	return (
		...
		<h2
			className={`${isUpgradePage ? 'mt-20' : 'mt-9'} mb-10 text-center text-3xl font-semibold text-gray-800 sm:text-4xl`}
		>
				...
				<div className="fixed right-0 bottom-5 left-0 z-50 flex w-full items-center justify-center">
					<div className="fixed right-0 bottom-5 left-0 z-50 flex w-full items-center justify-center">
						...
						{selectedPlan?.interval === 12 && showTooltip && (
							<div className="absolute -top-16 left-6 z-50 w-[280px] lg:left-20">
...
export default PlansContainer1;
